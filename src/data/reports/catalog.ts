...
export function formatReportDate(d: Date = new Date(), time?: string): string {
...
export function getRelativeReportDate(offsetDays = 0, time = '07:00'): string {
  const d = new Date();
  if (offsetDays !== 0) d.setDate(d.getDate() + offsetDays);
  return formatReportDate(d, time);
}
...
export const REPORT_DEFS: ReportDef[] = [
  /* ── Discovery and reconciliation ── */
  {
    ...
    state: 'Current', lastRun: getRelativeReportDate(0, '07:00'), snapshot: 'TRUST-2026-W36'
  },
  {
    ...
    state: 'Current', lastRun: getRelativeReportDate(0, '07:00'), snapshot: 'BKLG-2026-09-01'
  },
  {
    ...
    state: 'Current', lastRun: getRelativeReportDate(0, '07:30'), snapshot: 'EXC-2026-09-01'
  },
  {
    ...
    state: 'Current', lastRun: getRelativeReportDate(0, '06:00'), snapshot: 'DISC-2026-09-01'
  },
  {
    ...
    state: 'Stale', lastRun: getRelativeReportDate(-7, '07:00'), snapshot: 'AUTO-2026-W35',
  ...
  },
  {
    ...
    state: 'Current', lastRun: getRelativeReportDate(-3, '16:00'), snapshot: 'RULE-2026-W35'
  },
  {
    ...
    state: 'Current', lastRun: getRelativeReportDate(0, '08:00'), snapshot: 'COST-2026-09'
  },
  ...
  /* ── Inventory ── */
  {
    ...
    state: 'Current', lastRun: getRelativeReportDate(0, '07:00'), snapshot: 'EST-2026-09'
  },
  {
    ...
    state: 'Current', lastRun: getRelativeReportDate(0, '06:00'), snapshot: 'STK-2026-W36'
  },
  {
    ...
    state: 'Current', lastRun: getRelativeReportDate(0, '07:30'), snapshot: 'LCR-2026-09'
  },
  {
    ...
    state: 'Current', lastRun: getRelativeReportDate(0, '06:30'), snapshot: 'DQ-2026-W36'
  },
  {
    ...
    state: 'Running', lastRun: getRelativeReportDate(0, '08:00'), snapshot: 'ARC-2026-09',
  ...
  },
  {
    ...
    state: 'Current', lastRun: getRelativeReportDate(0, '09:00'), snapshot: 'SITE-2026-09'
  },
  {
    ...
    state: 'Failed', lastRun: getRelativeReportDate(-1, '09:30'), snapshot: 'OEM-2026-08',
    note: 'The EMS vendor feed run failed while reading the EMS vendor feed. Figures below are from the last successful run; a retry is queued.'
  }
];
