...
export const REPORT_RUNS: ReportRun[] = [
  ...
  { status: 'Completed', name: 'NETWORK-DISCOVERY-SUMMARY', type: 'Discovery', generated: 'Automated', frequency: 'Daily', creator: 'scheduler', createdOn: '01-Sep-2026', size: '4.2 MB', module: 'discovery' },
  { status: 'Completed', name: 'RECONCILIATION-EXCEPTIONS', type: 'Discovery', generated: 'Automated', frequency: 'Daily', creator: 'scheduler', createdOn: '01-Sep-2026', size: '1.8 MB', module: 'discovery' },
  ...
  { status: 'Completed', name: 'COLLECTOR-CREDENTIAL-FAILURES', type: 'Discovery', generated: 'Automated', frequency: 'Daily', creator: 'scheduler', createdOn: '01-Sep-2026', size: '910 KB', module: 'discovery' },
  { status: 'Pending', name: 'KOL-204-RRU-POWER-AUDIT', type: 'Site', generated: 'Scheduled', frequency: 'Weekly', creator: 'Rohan Mehta', createdOn: '01-Sep-2026', size: '—', module: 'inventory' }
];
