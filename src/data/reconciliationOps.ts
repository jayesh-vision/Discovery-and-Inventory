...
export const RECONCILE_JOBS: ReconcileJob[] = [
  ...
  { id: 'RCJ-TRN-02', domain: 'Transport', source: 'Network · NETCONF', target: 'Transport asset register',
...
export const RECONCILE_RESULTS: ReconcileResult[] = [
  ...
  { id: 'RCR-0005', element: 'BLR-UPF-CORE-05', domain: 'Core', outcome: 'Attribute mismatch',
    mismatchedFields: ['Serving PLMN'], verified: '31-Aug-2026 21:00', ruleId: 'RUL-CORE-002' },
  ...
  { id: 'RCR-0007', element: 'MUM-ROADM-RING-03', domain: 'Transport', outcome: 'Extra entity',
    mismatchedFields: ['Optical module present, no service record'], verified: '01-Sep-2026 06:00', ruleId: 'RUL-TRN-002' },
...
export const RECONCILE_EXCEPTIONS: ReconcileException[] = [
  ...
  { id: 'RX-5005', state: 'Drifted', domain: 'Core', subject: 'BLR-UPF-CORE-05 · serving PLMN',
    detected: '31-Aug-2026', owner: 'Gaurav Shukla', age: 2, sla: 'On track', next: 'Re-verify PLMN/slice assignment against the NRF profile', ruleId: 'RUL-CORE-002' },
